...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  mixins: [laravel_nova__WEBPACK_IMPORTED_MODULE_0__.FormField, laravel_nova__WEBPACK_IMPORTED_MODULE_0__.HandlesValidationErrors, _request__WEBPACK_IMPORTED_MODULE_1__["default"]],
  data: function data() {
    return {
      nodes: []
    };
  ...
  methods: {
    ...
    // 获取子节点
    loadChildNodes: function loadChildNodes(parent) {
      if (parent !== null && parent.children !== undefined) return;
      var p_code = parent === null ? '' : parent.key;
      var nodes = [];
      for (var code in this.lists) {
        if (code.length !== p_code.length + 2) continue;
        if (p_code !== '' && !code.startsWith(p_code)) continue;
        nodes.push({
          key: code,
          label: '[' + code + ']' + this.lists[code],
          leaf: code.length >= 8
        });
      }
      if (parent === null) return this.nodes = nodes;
      if (nodes.length === 0) parent.leaf = true;else parent.children = nodes;
    },
    // 循环获取子节点，由于性能问题暂且弃用
    getChildNodes: function getChildNodes(nodes, parent_code) {
      for (var code in this.lists) {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_HxTable = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("HxTable");
      ...
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Splitter, {
        ...
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_SplitterPanel, null, {
            "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
              return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_HxTable, {
                columns: _ctx.columns,
                lists: _ctx.lists,
                style: {
                  "min-height": "360px"
                }
              }, null, 8 /* PROPS */, ["columns", "lists"])];
            }),
            _: 1 /* STABLE */
          }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_SplitterPanel, null, {
            "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
              return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Tree, {
                selectionKeys: _ctx.selected,
                "onUpdate:selectionKeys": _cache[0] || (_cache[0] = function ($event) {
                  return _ctx.selected = $event;
                }),
                value: $data.nodes,
                onNodeExpand: $options.loadChildNodes,
                selectionMode: "checkbox",
                onNodeSelect: _ctx.getSelected,
                onNodeUnselect: _ctx.getSelected
              }, null, 8 /* PROPS */, ["selectionKeys", "value", "onNodeExpand", "onNodeSelect", "onNodeUnselect"])];
            }),
            _: 1 /* STABLE */
          })];
        }),
...
Nova.booting(function (app, store) {
  app.component('index-tree-select', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-tree-select', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-tree-select', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    // 加载全量数据
    loadLists: function loadLists(callback) {
      var _this = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _int, response, lists;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _int = _this.field.formatInt || false;
              _context.next = 3;
              return Nova.request().post(_this.field.options);
            case 3:
              response = _context.sent;
              lists = response.data.resources.map(function (item) {
...
/* harmony import */ var _Users_zhushu_ERP_field_nova_components_TreeSelect_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_Users_zhushu_ERP_field_nova_components_TreeSelect_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkjshxl_tree_select"] = self["webpackChunkjshxl_tree_select"] || [];
